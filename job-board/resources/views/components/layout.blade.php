                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/" :active="request()->is('/')" id="ABC"
                    ...
                    <div class="md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            @else
                                <a class="text-gray-400 hover:text-white px-2" href="/signup">Signup</a>
                                <a class="text-gray-400 hover:text-white px-2" href="/login">Login</a>
                            @endauth
