                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" value="{{ old("title")}}" id="title"
                                ...
                                class="{{$errors->has('title') ? "outline-red-500" : "outline-gray-300"  }}  {{$input_class}}" />
                        </div>
                        @error('title')
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" value="{{ old('author') }}" name="author" id="author"
                                ...
                                class="{{$errors->has('author') ? "outline-red-500" : "outline-gray-300"}} {{$input_class}}" />
                        </div>
                        @error('author')
                            <span class="text-red-500">{{$message}}</span>
                        @enderror
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea name="body" id="body" rows="3"
                                class="{{$errors->has('author') ? "outline-red-500" : "outline-gray-300"}} {{$input_class}}">{{ old('body') }}</textarea>
                        </div>
